...
$(`<div class="customizer-links">
  <div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical"> <a
      class="nav-link" id="c-pills-home-tab" data-toggle="pill" href="#c-pills-home" role="tab"
      aria-controls="c-pills-home" aria-selected="true">
      <div class="settings"><img src="../assets/images/customize.png" alt="" /></div>
    </a> <a class="nav-link" id="c-pills-profile-tab" data-toggle="pill" href="#c-pills-profile" role="tab"
...
<div class="customizer-contain">
  <div class="tab-content" id="c-pills-tabContent">
    <div class="customizer-body custom-scrollbar"> <i class="icofont-close icon-close"></i>
      <div class="tab-pane fade show active" id="c-pills-home" role="tabpanel" aria-labelledby="c-pills-home-tab">
        ...
        <ul class="main-layout layout-grid">
          ...
          <li data-attr="ltr" class="box-layout">
            <div class="header bg-light">
              <ul>
                <li></li>
                <li></li>
            ...
            <div class="body">
              <ul>
                <li class="bg-dark sidebar"></li>
                <li class="bg-light body"> <span class="badge badge-dark">Box Layout</span></li>
              </ul>
            </div>
          </li>
        </ul>
